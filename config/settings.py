...
SECRET_KEY = 'django-insecure-!-9(7tbyjc0-t3%8ao4rg3-%w7cmckhcpi2@kp!s+$v+z57am^'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Aquí puedes poner tus carpetas de templates si las usas
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',         # ✅ Agrega este
